...
final class Integration extends AbstractGatewayIntegration {
	...
	public function get_settings_fields() {
		...
		$fields[] = [
			...
			'section'  => 'general',
			'title'    => \_x( 'Refresh Token', 'omnikassa', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
			'type'     => 'textarea',
		];
		...
		$fields[] = [
			...
			'section'  => 'general',
			'title'    => \_x( 'Signing Key', 'omnikassa', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
			'type'     => 'text',
		];
		...
		$fields[] = [
			...
			'description' => \sprintf(
				...
				\__( 'Available tags:', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
				\sprintf(
				...
				\sprintf(
					...
					\__( 'Default: <code>%s</code>', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
					'{payment_id}'
				)
			),
			'meta_key'    => '_pronamic_gateway_omnikassa_2_order_id',
			'section'     => 'advanced',
			'title'       => \__( 'Order ID', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
			'tooltip'     => \sprintf(
				/* translators: %s: <code>merchantOrderId</code> */
				\__( 'This setting defines the Rabo Smart Pay %s field.', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
				$code_field
			),
			'type'        => 'text',
		];
		...
		$fields[] = [
			...
			'readonly' => true,
			'section'  => 'feedback',
			'title'    => \__( 'Webhook URL', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
			'tooltip'  => \__(
