...
class IDealIssuerSelectField extends SelectField {
	...
	protected function setup() {
		...
		$this->set_label( \__( 'Bank', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ) );
	}
	...
	public function get_options() {
		...
		return [
			 ...
			 */
			new SelectFieldOption( '', __( '— Choose your bank —', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ) ),
