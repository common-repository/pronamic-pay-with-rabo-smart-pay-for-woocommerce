...
if ( empty( $notes ) ) : ?>
	...
	<?php esc_html_e( 'No notes found.', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ); ?>
	...
	<table class="pronamic-pay-table widefat">
		<thead>
			<tr>
				...
				<th scope="col"><?php esc_html_e( 'Note', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ); ?></th>
