...
$details = [
	[
		'term'        => __( 'Description', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
...
if ( null !== $phase ) {
	// Amount.
	$details[] = [
		'term'        => __( 'Amount', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
...
if ( ! empty( $payment_method ) ) {
	$details[] = [
		'term'        => __( 'Payment method', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
...
// Recurrence.
$details[] = [
	'term'        => __( 'Recurrence', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ),
	'description' => $recurrence,
];

?>

<h2><?php esc_html_e( 'Subscription', 'pronamic-pay-with-rabo-smart-pay-for-woocommerce' ); ?></h2>
